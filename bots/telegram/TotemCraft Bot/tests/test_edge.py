...
P = 7001
log = say(P, '/start')
check(any('Выберите язык' in t for t in texts_to(log, P)), "/start нового игрока: сначала выбор языка")
_, log = press(P, 'lang_ru')
check(any('Главное меню' in t for t in texts_to(log, P)), "выбрал русский: главное меню игрока")
press(P, 'menu_apply')
log = say(P, 'ab')

...
check(any('крок 1 з 3' in t and 'Введіть ваш нік' in t for t in sent_to(log, UA)), "шаг 1 и вопрос про ник по-украински")
...
log = say(UA, 'Taras_UA')
check(any('крок 2 з 3' in t and 'Введіть пароль' in t for t in sent_to(log, UA)), "шаг 2 и вопрос про пароль по-украински")
log = say(UA, '123456')
...
check(any('step 1 of 3' in t and 'Enter your Minecraft nickname' in t for t in sent_to(log, EN)),

...
check(any('крок 1 з 2' in t and 'Введіть ваш нік' in t for t in sent_to(log, UA)), "шаг 1 и вопрос про ник по-украински")
...
log = say(UA, 'Taras_UA')
check(any('крок 2 з 2' in t and 'Введіть пароль' in t for t in sent_to(log, UA)), "шаг 2 и вопрос про пароль по-украински")
log = say(UA, '123456')
...
check(any('step 1 of 2' in t and 'Enter your Minecraft nickname' in t for t in sent_to(log, EN)),
      "шаг 1 и вопрос про ник по-английски")
say(EN, 'JohnCraft')
...
check(any('Звернення #' in t and 'надіслано' in t for t in sent_to(log, UA)), "номер обращения в заголовке, по-украински")
